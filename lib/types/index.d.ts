 ...
 * Event types
 */
export type I18nEventType = 'loaded' | 'loading' | 'loadError' | 'localeChanged' | 'namespaceLoaded' | 'missingKey' | 'fallback' | 'initialized' | 'pluginInstalled' | 'pluginUninstalled';
/**
 * Event data
 */
 ...
 * Missing key handler
 */
export type MissingKeyHandler = (key: string, locale: Locale, namespace?: string, fallbackValue?: string) => string;
/**
 * Error handler
 */
