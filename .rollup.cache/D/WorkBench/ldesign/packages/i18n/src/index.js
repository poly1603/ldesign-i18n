...
export { createVueI18n, I18nT, useCurrency, useDate, useNumber, usePlural, useRelativeTime, useTranslation, vI18n } from './adapters/vue';
...
export { createDefaultI18nEnginePlugin, createI18nEnginePlugin, i18nPlugin } from './engine';
...
export { createI18nPlugin, useI18n as useI18nPlugin } from './plugin';
