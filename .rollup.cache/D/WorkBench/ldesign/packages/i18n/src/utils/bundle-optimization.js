 ...
 */
export async function lazyLoadPlugin(pluginName) {
 ...
 */
export async function conditionalImport(feature, importFn) {
    if (FEATURES[feature]) {
        return importFn();
    }
    return null;
 ...
 */
export function createMinimalI18n(config) {
 ...
 */
export function generatePreloadHints(locales) {
    const hints = [];
...
export const ESM_ONLY = {
    ...
    dynamicImport: (path) => import(/* @vite-ignore */ path),
 ...
 */
/*#__PURE__*/ export function pureFormatNumber(value, locale) {
    return new Intl.NumberFormat(locale).format(value);
}
/*#__PURE__*/ export function pureFormatDate(value, locale) {
    return new Intl.DateTimeFormat(locale).format(value);
}
/*#__PURE__*/ export function pureCapitalize(str) {
 ...
 */
export function analyzeExportSizes() {
    const sizes = new Map();
 ...
 */
export function getBundleSizeRecommendations(currentSize) {
...
//# sourceMappingURL=bundle-optimization.js.map