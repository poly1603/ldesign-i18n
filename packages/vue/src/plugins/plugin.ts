...
import { I18N_SYMBOL, setGlobalI18nInstance } from '../core/constants'
import { vT, vTHtml, vTPlural, vTTooltip, vTDate, vTNumber } from '../directives'
    ...
    install(app: App) {
      ...
      if (typeof document !== 'undefined' && typeof window !== 'undefined') {
        ...
        if (!document.getElementById(styleId)) {
          ...
          catch { /* styles may not be available in all environments */ }
        }
      }

      // Provide i18n instance
      app.provide(I18N_SYMBOL, i18n)
      setGlobalI18nInstance(i18n)
      ...
      if (directives) {
        ...
        app.directive('t-tooltip', vTTooltip)
        app.directive('t-date', vTDate)
        app.directive('t-number', vTNumber)
      }
